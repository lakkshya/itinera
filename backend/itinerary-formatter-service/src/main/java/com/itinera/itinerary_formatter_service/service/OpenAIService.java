package com.itinera.itinerary_formatter_service.service;
...
import com.itinera.itinerary_formatter_service.utils.PromptBuilder;
...
public class OpenAIService {
    ...
    public OpenAIService(StringRedisTemplate redisTemplate) {
    ...
    public String generateItinerary(String city, ItineraryRequest data) {
        try {
            ...
            Request request = new Request.Builder()
                    ...
                    .addHeader("X-Title", "Itinerary Formatter Service")
                    .post(requestBody)
                    .build();
